...
cp in_cld_mls15 IN_CLD_RRTM
cp input_mls_spc INPUT_RRTM
rrtmg_sw
cp OUTPUT_RRTM out_mls_spc15
cp input_mls_brd INPUT_RRTM
rrtmg_sw
cp OUTPUT_RRTM out_mls_brd15

cp in_cld_mls25 IN_CLD_RRTM
cp input_mls_spc INPUT_RRTM
rrtmg_sw
cp OUTPUT_RRTM out_mls_spc25
cp input_mls_brd INPUT_RRTM
rrtmg_sw
cp OUTPUT_RRTM out_mls_brd25

cp in_cld_mls35 IN_CLD_RRTM
cp input_mls_spc INPUT_RRTM
rrtmg_sw
cp OUTPUT_RRTM out_mls_spc35
cp input_mls_brd INPUT_RRTM
rrtmg_sw
cp OUTPUT_RRTM out_mls_brd35


cp in_cld_mls55 IN_CLD_RRTM
cp input_mls_spc INPUT_RRTM
rrtmg_sw
cp OUTPUT_RRTM out_mls_spc55
cp input_mls_brd INPUT_RRTM
rrtmg_sw
cp OUTPUT_RRTM out_mls_brd55


cp in_cld_mls70 IN_CLD_RRTM
cp input_mls_spc INPUT_RRTM
rrtmg_sw
cp OUTPUT_RRTM out_mls_spc70
cp input_mls_brd INPUT_RRTM
rrtmg_sw
cp OUTPUT_RRTM out_mls_brd70


cp in_cld_mls75 IN_CLD_RRTM
cp input_mls_spc INPUT_RRTM
rrtmg_sw
cp OUTPUT_RRTM out_mls_spc75
cp input_mls_brd INPUT_RRTM
rrtmg_sw
cp OUTPUT_RRTM out_mls_brd75


cp in_cld_mls100 IN_CLD_RRTM
cp input_mls_spc INPUT_RRTM
rrtmg_sw
